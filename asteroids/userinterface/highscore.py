"""
Модуль регистрации рекордов.

Обеспечивает интерактивный ввод имени игрока (до 3-х символов) при достижении 
нового лучшего результата. Включает визуализацию поля ввода с мигающим курсором 
и фильтрацию вводимых символов.
"""
import pygame
