"""Игровой модуль «Player» — управляемый корабль игрока.

Основные обязанности:


- хранит здоровье (health) и таймер перезарядки выстрела (timer);

- поворачивается и перемещается по полю;

- отрисовывается в виде треугольника;

- сообщает через shoot(), можно ли произвести выстрел.

Константы скорости, радиуса и времени кулдауна берутся из модуля constants.
